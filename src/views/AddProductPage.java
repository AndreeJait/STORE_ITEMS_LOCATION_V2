...
public class AddProductPage extends javax.swing.JFrame {
    ...
    private void btnSubmitMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnSubmitMouseClicked
        ...
        if(this.validates()){
            ...
            Product p = new Product(name, location, price, quantity);
            
            if(p.insertIntoDatabae()){
                AppUtils.showDialogSuccess(this, false, "Success to insert data with id " 
                        + p.getID(), "Succes to Insert");
                this.setEmpty();
            }else{
                 AppUtils.showDialogError(this, false, 
                    "Failed to insert data", "SQL Error");
            }
        }else{
            AppUtils.showDialogError(this, false, 
